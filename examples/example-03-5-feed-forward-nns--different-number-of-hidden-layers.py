...
# Training MSE = 1.625840663909912
# Cost function at epoch of 1000:
# Training MSE = 0.313249796628952
# Learning time = 46.67 minutes
# *****************************************************************
# Structure: 10-10-10
# ...
# Cost function at epoch of 0:
# Training MSE = 2.1611580848693848
# Cost function at epoch of 1000:
# Training MSE = 0.28134486079216003
# Learning time = 46.26 minutes
# *****************************************************************
# Structure: 10-10-10-10
# ...
# Cost function at epoch of 0:
# Training MSE = 2.078244686126709
# Cost function at epoch of 1000:
# Training MSE = 0.2682289779186249
# Learning time = 49.55 minutes
# *****************************************************************
# Structure: 10-10-10-10-10
# ...
# Cost function at epoch of 0:
# Training MSE = 2.2416133880615234
# Cost function at epoch of 1000:
# Training MSE = 0.2717546820640564
# Learning time = 50.54 minutes
# *****************************************************************
# Structure: 100-100-100-100-10
# ...
# Cost function at epoch of 0:
# Training MSE = 1.6713241338729858
# Cost function at epoch of 1000:
# Training MSE = 0.00023964497086126357
# Learning time = 73.76 minutes
...
plt.title('Different number of hidden layers', fontproperties=fm.FontProperties(fname=fp))
plt.legend(loc='best')
plt.ylim(0.0, 1.0)
plt.xlim(0, EPOCHS)
plt.axis(True)
